...
#ifndef SRC_GRAPH_ALGO_BFSVISITOR_BFSVISITOR_H_
#define SRC_GRAPH_ALGO_BFSVISITOR_BFSVISITOR_H_
...
class BfsVisitor {
public:
	BfsVisitor(const SparseGraph* graph);
	virtual ~BfsVisitor();
...
private:
	...
	std::queue<uint32_t> visitQueue_;
...
#endif /* SRC_GRAPH_ALGO_BFSVISITOR_BFSVISITOR_H_ */
